<?php
/**
 * Class Test_Static_No_Init
 *
 * @package PJ\HooksHelper
 */

/**
 * Tests for a static class that does not require an init method.
 */
class Test_Static_No_Init extends WP_UnitTestCase {

    public function setUp(): void {
        parent::setUp();
        
        // This will register the hooks for the ExampleStaticPluginClass.
        ExampleStaticPluginClass::init();
    }
...
class ExampleStaticPluginClass {
