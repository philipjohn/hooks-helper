<?php
/**
 * Class Test_Standard_Class_With_Constructor
 *
 * @package PJ\HooksHelper
 */

/**
 * Tests for a standard class that has a constructor method.
 */
class Test_Standard_Class_With_Constructor extends WP_UnitTestCase {

    /**
     * The plugin class instance.
     *
     * @var ExampleStandardPluginClassWithConstructor
     */
    ...
    public function setUp(): void {
        ...
        // This will register the hooks for the ExampleStandardPluginClassWithConstructor.
        $this->plugin_class = new ExampleStandardPluginClassWithConstructor();
    }
...
class ExampleStandardPluginClassWithConstructor {
