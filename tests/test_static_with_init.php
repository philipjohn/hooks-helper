<?php
/**
 * Class Test_Static_With_Init
 *
 * @package PJ\HooksHelper
 */

/**
 * Tests for a static class that has an init method.
 */
class Test_Static_With_Init extends WP_UnitTestCase {

    public function setUp(): void {
        parent::setUp();
        
        // This will register the hooks for the ExampleStaticPluginClass.
        ExampleStaticPluginWithInitClass::init();
    }
	...
	public function test_hooks_registered() {
        ...
        $wp_head_hook = $wp_filter['wp_head']->has_filter( 'ExampleStaticPluginClass::action_wp_head' );
        ...
        $the_content_hook = $wp_filter['the_content']->has_filter( 'ExampleStaticPluginClass::filter_the_content' );
        ...
        $wp_body_open_hook = $wp_filter['wp_body_open']->has_filter( 'ExampleStaticPluginClass::action_wp_body_open' );
...
class ExampleStaticPluginWithInitClass {
